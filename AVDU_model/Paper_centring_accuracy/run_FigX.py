...
Model_dir = "/Users/alex/Dropbox/Work/Papers/corridor_centre_paper/Model/Paper_centring_accuracy/"

print 'Script to generate Figure for the paper, showing centring accuracy'

wall_freqs = [0.01, 0.02, 0.03, 0.04, 0.06, 0.08, 0.12, 0.16]
...
for i in xrange(0,4):
	if i == 0:
		...
		xml_file = "beeworldConfigCorridorp6.xml"
		poswall = 13
		negwall = -7
	if i == 1:
	...
	if i == 2:
		...
		xml_file = "beeworldConfigCorridorp15.xml"
		poswall = 13
		negwall = -7
	if i == 3:
